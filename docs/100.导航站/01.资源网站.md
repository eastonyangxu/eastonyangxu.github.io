...
export default {
    ...
    return {
      ...
      cardData9: [
        ...
        {
          cardSrc: "https://pixabay.com/",
          cardImgSrc: "/source/px.png",
          cardName: "pixabay",
          cardContent:"各种免费图片素材",
        },
      ],
      // CSS样式
      cardData10: [
      ...
      cardData12: [
        ...
        {
          cardSrc: "https://svgconverter.com/zh/",
          cardImgSrc: "/source/svgconverter.png",
          cardName: "svg converter",
          cardContent:
            "SVG转换器",
        },
      ],
